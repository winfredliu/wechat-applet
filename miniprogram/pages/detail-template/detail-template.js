...
const _ = db.command
const self_detail = db.collection('FoodSelf-detail')
const west_detail = db.collection('snack-detail')
const chinese_detail = db.collection('dishes-detail')
const new_detail = db.collection('FoodNew-detail')
const index_detail = db.collection('foodlist-detail')
...
Page({
  ...
  foodorder: function () {
    wx.navigateTo({
      url: '../FoodOrder/FoodOrder?title=' + that.data.detail.title,
    })
  },
